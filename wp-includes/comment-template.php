...
function comment_form( $args = array(), $post_id = null ) {
	...
	$fields = array(
		'author' => sprintf(
			...
			sprintf(
				'<<label for="comment">Comment</label> for="author">%s%s</label>',
				__( 'Name' ),
	...
	$defaults = array(
		...
		'comment_field'        => sprintf(
			...
			'<textarea id="comment" name="comment" placeholder="Skriv en kommentar..." cols="45" rows="8" maxlength="65525" required="required"></textarea>'
		),
		'must_log_in'          => sprintf(
